...
Then we try to inject a percentage of generated images into the training dataset and we evaluate the model performance
...
* **Data_augmentation.py:** Contains code for generating new images from originals.
